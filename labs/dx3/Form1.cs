...
namespace dx
{
    public partial class Form1 : Form
    {
        ...
        public void Initialize()
        {
            ...
            Bitmap b = (Bitmap)Image.FromFile("Resources/texture.bmp");
            texture = new Texture(device, b, 0, Pool.Managed);
            ...
            CustomVertex.PositionNormalTextured[] vertices = new CustomVertex.PositionNormalTextured[24];
            //up
